...
import com.renato.controleFinancas.model.DTO.AtualizaStatusDTO;
import com.renato.controleFinancas.model.DTO.LancamentoDTO;
...
public class LancamentoRecource {
	...
	public ResponseEntity salvar(@RequestBody LancamentoDTO dto) {
		try {
			...
			lancamentoService.salvar(novoLancamento);
